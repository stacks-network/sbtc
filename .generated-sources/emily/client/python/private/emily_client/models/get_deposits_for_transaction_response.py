...
class GetDepositsForTransactionResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deposits": [Deposit.from_dict(_item) for _item in obj["deposits"]] if obj.get("deposits") is not None else None,
