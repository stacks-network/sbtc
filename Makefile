...
EMILY_CLIENTS_DIR := $(AUTOGENERATED_SOURCES)/emily/client
EMILY_RUST_CLIENTS_DIR := $(EMILY_CLIENTS_DIR)/rust

EMILY_CLIENT_SOURCE_FILES := $(shell find $(EMILY_RUST_CLIENTS_DIR) -type f -name 'lib.rs')
