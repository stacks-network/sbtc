...
class UpdateDepositsRequestBody(BaseModel):
    """
    Request structure for update deposit request.
    """ # noqa: E501
    deposits: List[DepositUpdate] = Field(description="Bitcoin transaction id.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deposits": [DepositUpdate.from_dict(_item) for _item in obj["deposits"]] if obj.get("deposits") is not None else None
        })
        return _obj
