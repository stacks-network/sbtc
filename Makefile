...
lint: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
	cargo clippy -- -D warnings
	# TODO(719): No need to do this once rustfmt 2.0.0 ships
	# Format generated sources:
	cargo fmt -p "emily-openapi-spec" -p "emily-client" -p "blocklist-api"
	cargo fmt --all -- --check
...
vet: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
