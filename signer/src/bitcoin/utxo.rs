...
pub struct WithdrawalRequest {
    ...
    /// `initiate-wiithdrawal-request` public function was called.
    pub request_id: u64,
...
impl<'a> UnsignedTransaction<'a> {
    ...
    ///
    /// For more on the rational for this output, see this ticket:
    /// <https://github.com/stacks-network/sbtc/issues/483>.
    ///
    /// `None` is returned if the are no withdrawal requests in the input
    /// slice.
...
mod tests {
    ...
    fn the_bitmaps_merge_correctly() {
        ...
        // merkle root is included at the end of the `data`, bringing it's
