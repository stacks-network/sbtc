...
mod tests {
    ...
    use network::in_memory2::SignerNetwork;
    use rand::SeedableRng as _;
    use test_log::test;

    use crate::bitcoin::MockBitcoinInteract;
    use crate::emily_client::MockEmilyInteract;
    use crate::keys::{PublicKey, SignerScriptPubKey};
    ...
    async fn test_get_btc_state_with_available_sweep_transactions_and_rbf() {
        ...
        let mut sweep_transactions1: Vec<model::SweepTransaction> =
        ...
        let mut sweep_transactions2: Vec<model::SweepTransaction> =
            fake::Faker.fake_with_rng(&mut rng);
