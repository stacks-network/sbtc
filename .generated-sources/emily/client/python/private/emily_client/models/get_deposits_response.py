...
class GetDepositsResponse(BaseModel):
    ...
    """ # noqa: E501
    deposits: List[DepositInfo] = Field(description="Deposit infos: deposits with a little less data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deposits": [DepositInfo.from_dict(_item) for _item in obj["deposits"]] if obj.get("deposits") is not None else None,
