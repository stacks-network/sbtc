...
#[openapi(
    ...
    paths(
        ...
        // api::handlers::deposit::update_deposits, // users may not update the state of existing deposits.
        // Withdrawal endpoints.
        api::handlers::withdrawal::get_withdrawal,
        api::handlers::withdrawal::get_withdrawals,
        // api::handlers::withdrawal::create_withdrawal, // users may not alter the state of withdrawals.
        // api::handlers::withdrawal::update_withdrawals, // users may not alter the state of withdrawals.
        // Chainstate endpoints.
        api::handlers::chainstate::get_chain_tip,
        api::handlers::chainstate::get_chainstate_at_height,
        // api::handlers::chainstate::set_chainstate, // users may not alter the state of the chain.
        // api::handlers::chainstate::update_chainstate, // users may not alter the state of the chain.
        // Testing endpoints.
        api::handlers::testing::wipe_databases,
        // Limits endpoints.
        api::handlers::limits::get_limits,
        // api::handlers::limits::set_limits, // users may not set limits.
        api::handlers::limits::get_limits_for_account,
        // api::handlers::limits::set_limits_for_account, // users may not set limits.
    ),
