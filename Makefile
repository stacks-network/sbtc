...
build: blocklist-client-build emily-client-build
...
$(info $(EMILY_OPENAPI_SPECS_DIR))
$(info $(EMILY_OPENAPI_SPEC_PATHS))
$(info $(EMILY_CLIENT_SOURCE_FILES))
...
BLOCKLIST_CLIENT_SOURCE_FILES := $(shell find $(AUTOGENERATED_SOURCES)/blocklist-api/src -type f -name 'lib.rs')
