...
impl DepositUpdate {
    ...
    pub fn new(bitcoin_tx_output_index: u32, bitcoin_txid: String, last_update_block_hash: String, last_update_height: u64, status: models::Status, status_message: String) -> DepositUpdate {
        DepositUpdate {
