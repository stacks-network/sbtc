...
BTC_LIVENESS_SUCCESS_FRMT=$([ "$BTC_LIVENESS_SUCCESS" == "true" ] && echo -e "\033[1;32m$BTC_LIVENESS_SUCCESS\033[0m ✅" || echo -e "\033[1;31m$BTC_LIVENESS_SUCCESS\033[0m❌")
...
BTC_MINEABLE_SUCCESS_FRMT=$([ "$BTC_MINEABLE_SUCCESS" == "true" ] && echo -e "\033[1;32m$BTC_MINEABLE_SUCCESS\033[0m ✅" || echo -e "\033[1;31m$BTC_MINEABLE_SUCCESS\033[0m❌")
...
MARIADB_READY_SUCCESS_FRMT=$(echo -e "\033[1;31m$MARIADB_READY_SUCCESS\033[0m❌")
...
STX_SYNC_WITH_BTC_UTXO_SUCCESS_FRMT=$([ "$STX_SYNC_WITH_BTC_UTXO_SUCCESS" == "true" ] && echo -e "\033[1;32m$STX_SYNC_WITH_BTC_UTXO_SUCCESS\033[0m ✅" || echo -e "\033[1;31m$STX_SYNC_WITH_BTC_UTXO_SUCCESS\033[0m❌")
...
STACKS_API_EVENT_OBSERVER_LIVENESS_SUCCESS_FRMT=$([ "$STACKS_API_EVENT_OBSERVER_LIVENESS_SUCCESS" == "true" ] && echo -e "\033[1;32m$STACKS_API_EVENT_OBSERVER_LIVENESS_SUCCESS\033[0m ✅" || echo -e "\033[1;31m$STACKS_API_EVENT_OBSERVER_LIVENESS_SUCCESS\033[0m❌")
...
STACKS_PUBLIC_API_LIVENESS_SUCCESS_FRMT=$(echo -e "\033[1;31m$STACKS_API_PUBLIC_LIVENESS_SUCCESS\033[0m❌")
