...
integration-test-serial: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
	cargo nextest run --test integration --features integration-tests --no-fail-fast --test-threads=1

integration-test-parallel: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
	cargo nextest run --test integration --features integration-tests-parallel --no-fail-fast --test-threads=6
