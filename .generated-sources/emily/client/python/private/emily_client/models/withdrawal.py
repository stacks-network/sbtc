...
class Withdrawal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "fulfillment", "lastUpdateBlockHash", "lastUpdateHeight", "parameters", "recipient", "requestId", "stacksBlockHash", "stacksBlockHeight", "status", "statusMessage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": WithdrawalParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
