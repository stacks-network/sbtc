...
# TODO:
# Uncomment after adding emily api spec generation.

# EMILY_DEVENV_PATH=emily/devenv
EMILY_HANDLER_PATH=emily/handler
EMILY_API_PROJECT_NAME=emily-handler
...
# Builds the Lambda usable Emily client.
$(EMILY_LAMBDA_BINARY):
	cargo lambda build \
		--release \
...
# Triggers the emily lambda build manually.
