...
pub struct AccountLimits {
    ...
    #[serde(rename = "pegCap", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub peg_cap: Option<Option<u64>>,
    /// Per deposit cap. If none then the cap is the same as the global per deposit cap.
    #[serde(rename = "perDepositCap", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub per_deposit_cap: Option<Option<u64>>,
    /// Per deposit minimum. If none then there is no minimum.
    #[serde(rename = "perDepositMinimum", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "perWithdrawalCap", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub per_withdrawal_cap: Option<Option<u64>>,
    /// Per withdrawal minimum. If none then there is no minimum.
    #[serde(rename = "perWithdrawalMinimum", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
