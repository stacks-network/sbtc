...
impl WithdrawalInfo {
    ...
    pub fn new(amount: u64, last_update_block_hash: String, last_update_height: u64, recipient: String, request_id: u64, stacks_block_hash: String, stacks_block_height: u64, status: models::Status) -> WithdrawalInfo {
        WithdrawalInfo {
            amount,
