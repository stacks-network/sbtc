...
integration-test-serial: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
	cargo nextest run --test integration --features integration-tests --no-fail-fast --test-threads 1 --retries 3

integration-test-parallel: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT)
	cargo nextest run --test integration --features integration-tests-parallel --no-fail-fast --test-threads 6 --retries 3

integration-test-ci: $(AUTOGENERATED_BLOCKLIST_CLIENT_CLIENT) $(AUTOGENERATED_EMILY_CLIENT) integration-test-serial integration-test-parallel
...
integration-test-full: integration-env-down integration-env-up integration-test-serial integration-test-parallel integration-env-down
