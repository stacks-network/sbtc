...
build: $(INSTALL_TARGET) $(AUTOGENERATED_EMILY_CLIENT)
	cargo build
	pnpm --recursive build

test: $(INSTALL_TARGET) $(AUTOGENERATED_EMILY_CLIENT)
	cargo test
	pnpm --recursive test

integration-test: $(INSTALL_TARGET) $(AUTOGENERATED_EMILY_CLIENT)
	docker compose --file docker-compose.test.yml up --detach
	cargo test --all-features
	pnpm --recursive test
	docker compose --file docker-compose.test.yml down

lint: $(INSTALL_TARGET) $(AUTOGENERATED_EMILY_CLIENT)
