...
mod tests {
    ...
    #[test_case(create_deposit(3000, 10_000, 0), true; "should_reject_single_deposit_exceeding_max_mintable")]
    fn deposit_requests_respect_dust_limits(req: DepositRequest, is_included: bool) {
        ...
        let mut reqs = tx.requests.iter().filter_map(RequestRef::as_deposit);
        reqs.find(|req| req.outpoint == outpoint);
    }
