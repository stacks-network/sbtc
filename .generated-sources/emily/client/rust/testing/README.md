...
*LimitsApi* | [**get_limits**](docs/LimitsApi.md#get_limits) | **GET** /limits | Get chain tip handler.
*LimitsApi* | [**get_limits_for_account**](docs/LimitsApi.md#get_limits_for_account) | **GET** /limits/{account} | Update chainstate handler.
*LimitsApi* | [**set_limits**](docs/LimitsApi.md#set_limits) | **POST** /limits | Get chainstate handler.
*LimitsApi* | [**set_limits_for_account**](docs/LimitsApi.md#set_limits_for_account) | **POST** /limits/{account} | Set account limits handler.
